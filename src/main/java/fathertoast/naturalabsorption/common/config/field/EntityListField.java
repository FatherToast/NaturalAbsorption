...
public class EntityListField extends GenericField<EntityList> {
    ...
    private EntityEntry parseEntry( final String line ) {
        ...
        if( reqValues < 0 ) {
            if( actualValues < 1 ) {
                NaturalAbsorption.LOG.warn( "Entry has too few values for {} \"{}\"! Expected at least one value. " +
        ...
        // Specified value; must have the exact number of values
            ...
            if( reqValues > actualValues ) {
                NaturalAbsorption.LOG.warn( "Entry has too few values for {} \"{}\"! " +
                ...
                NaturalAbsorption.LOG.warn( "Entry has too many values for {} \"{}\"! " +
    ...
    private double parseValue( final String arg, final String line ) {
        ...
        try {
            ...
            NaturalAbsorption.LOG.warn( "Invalid value for {} \"{}\"! Falling back to 0. Invalid entry: {}",
                    getClass(), getKey(), line );
            value = 0.0;
        }
