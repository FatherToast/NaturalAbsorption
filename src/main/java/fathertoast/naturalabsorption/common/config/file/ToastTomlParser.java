...
public class ToastTomlParser implements ConfigParser<CommentedConfig> {
    ...
    public CommentedConfig parse( Reader reader ) {
        NaturalAbsorption.LOG.error( "Attempting to parse NEW config file! ({})", CONFIG_SPEC.CONFIG_FILE.getFile() );
    ...
    public void parse( Reader reader, Config destination, ParsingMode parsingMode ) {
        NaturalAbsorption.LOG.debug( "Parsing config file! ({}{})", CONFIG_SPEC.NAME, ToastConfigFormat.FILE_EXT );
