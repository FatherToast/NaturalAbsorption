package fathertoast.naturalabsorption.common.config.file;

import com.electronwill.nightconfig.core.NullObject;
import com.electronwill.nightconfig.core.utils.StringUtils;
import fathertoast.naturalabsorption.common.config.field.DoubleField;
import fathertoast.naturalabsorption.common.config.field.IntField;
...
public final class TomlHelper {
    ...
    private static String fieldRangeUpperLimit( Number max ) { return References.LESS_OR_EQUAL + " " + toLiteral( max ); }
    
    /** @return A range representation of toml literals with only a lower limit. */
    private static String fieldRangeLowerLimit( Number min ) { return References.GREATER_OR_EQUAL + " " + toLiteral( min ); }
