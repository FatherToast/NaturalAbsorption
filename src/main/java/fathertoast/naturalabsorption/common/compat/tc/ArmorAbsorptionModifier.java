...
public class ArmorAbsorptionModifier extends Modifier {
    ...
    @Override
    public void addInformation( IModifierToolStack tool, int level, @Nullable PlayerEntity player, List<ITextComponent> tooltip,
                                TooltipKey tooltipKey, TooltipFlag tooltipFlag ) {
        tooltip.add( new TranslationTextComponent( TextFormatting.YELLOW + new TranslationTextComponent(
